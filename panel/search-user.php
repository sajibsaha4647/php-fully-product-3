		  ...
		  <div class="panel-body">
			  <table class="table table-responsive table-striped table-hover table_cus">
					...
					<tbody>
						...
						<?php
							$Search=$_POST['Search'];
							$sel="SELECT * FROM new_users NATURAL JOIN new_roles WHERE user_name LIKE '%$Search%' OR user_phone LIKE '%$Search%' OR user_email LIKE '%$Search%'";
						...
						<tr>
							...
							<td>
								...
								<?php if($data['user_photo']==''){?>
									...
									<img src="uploads/avatar.png" height="50"/>
								
								<?php } else{?>
								
									<img src="uploads/<?=$data['user_photo']?>" height="50"/>
